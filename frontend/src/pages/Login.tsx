...
export function Login() {
  ...
  // Google OAuth is now the mandatory gateway
    ...
    <div className="h-full flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-[var(--fg)] leading-none">Secure Access</h2>
          <p className="text-xs font-medium mt-2 text-[var(--fg-dim)]">Sign in with Google to enter DeepStegAI</p>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-primary/5 border border-primary/10 rounded-2xl p-4 flex items-start gap-4">
             ...
             <p className="text-[10px] text-[var(--fg-dim)] leading-relaxed">
               For security reasons and to prevent fraudulent activity, only <span className="text-primary font-bold">Verified Google Accounts</span> are permitted to access the encryption core.
             </p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-[var(--border)] flex flex-col items-center gap-4">
          <p className="text-xs font-medium text-[var(--fg-dim)]/60 text-center">New to the protocol?</p>
          <Link to="/signup" className="flex items-center gap-3 text-sm font-semibold text-primary hover:glow-text transition-all group">
